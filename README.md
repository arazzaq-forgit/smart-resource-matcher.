...
├── data/
│   └── resources_sample.csv       <- 30 SYNTHETIC/PLACEHOLDER resources (fake city "Rivertown")
├── scripts/
...
**Important:** `data/resources_sample.csv` is **fake data I invented** (a made-up city
called "Rivertown" with made-up phone numbers and websites) purely so the whole
pipeline runs end-to-end and you can see it work immediately. You still need to do
Step 2 below (replace it with real organizations in your actual city) before your demo.
...
## 4. Upgrade to the "real" pipeline: sentence-transformers + Chroma (1-2 hrs)
